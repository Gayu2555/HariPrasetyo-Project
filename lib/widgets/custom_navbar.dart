...
class FloatingCustomNavBar extends StatefulWidget {
  const FloatingCustomNavBar({Key? key}) : super(key: key);

  @override
  FloatingCustomNavBarState createState() => FloatingCustomNavBarState();
}

class FloatingCustomNavBarState extends State<FloatingCustomNavBar> {
  int _selectedIndex = 0;
